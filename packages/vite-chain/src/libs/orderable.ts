export default function orderable<T>(Class: new (...args: any[]) => any) {
  class Orderable extends Class {
    __after?: string;
    __before?: string;
  ...
  const returnClass = Orderable;
  return returnClass as (typeof Orderable & T);
}
