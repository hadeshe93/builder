...
import { getResolve, getRequireResolve, getNodeModulePaths } from '@hadeshe93/lib-node';
...
export function getCommonChainConfig(oriParams: ParamsGetWebpackChainConfigs, chainConfig = new WebpackChainConfig()) {
